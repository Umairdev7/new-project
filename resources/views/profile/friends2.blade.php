				...
				<ul class="notification-list friend-requests">
					...
					<li>
						...
						<div class="notification-event">
							...
							<a href="#" class="h6 notification-friend">{{ $friend->name }}</a>
							{{-- <span class="chat-message-item">Mutual Friend: Sarah Hetfield</span> --}}
							<span class="chat-message-item"><p class="text-sm text-gray-500">{{ '@' . \Illuminate\Support\Str::slug($friend->name) }}</p></span>
						</div>
