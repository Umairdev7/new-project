...
<header class="px-2 py-4 mt-16 flex flex-col justify-center items-center text-center">
  <img class="inline-flex object-cover border-4 border-indigo-600 rounded-full shadow-[5px_5px_0_0_rgba(0,0,0,1)] shadow-indigo-600/100 bg-indigo-50 text-indigo-600 h-24 w-24 !h-48 !w-48" src="{{ $tweets->user->avatar }}" alt="">
  <h1 class="text-2xl text-gray-500 font-bold mt-2">
    {{ $tweets->user->name }}
  </h1>
  <hr>
  <h5 class="text-2xl text-gray-500 font-md mt-2">
    {{ $tweets->title }}
  </h5>
