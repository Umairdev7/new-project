...
$(document).ready(function(){
    ...
    $('#editTweetModal').on('show.bs.modal', function (event) {
        ...
        modal.find('#editTitle').val(button.data('title'));  // This sets the title value
		...
		<div class="table-wrapper">
			<div class="table-title">
				<div class="row">
					...
					<div class="col-sm-6">
						<a href="#addTweetModal" class="btn btn-success" data-toggle="modal" id="addUserBtn"><i class="material-icons">&#xE147;</i> <span>Add New Tweet</span></a>
						{{-- <a href="#deleteEmployeeModal" class="btn btn-danger" data-toggle="modal"><i class="material-icons">&#xE15C;</i> <span>Delete</span></a> --}}
						{{-- <a href="#deleteEmployeeModal" class="btn btn-danger" data-toggle="modal" id="deleteSelectedUsers"><i class="material-icons">&#xE15C;</i> <span>Delete</span></a> --}}
					</div>
				</div>
			</div>
			<table class="table table-striped table-hover">
				...
				<tbody>
					...
					<tr>
						...
						<td><a href="#" class="__cf_email__" data-cfemail="73071b1c1e12001b1201170a331e121a1f5d101c1e">{{ $tweet->user->name }}</a></td>
						<td>{{ $tweet->created_at->format('d M Y') }}</td>
						<td>
							<a href="#editTweetModal" class="edit" data-toggle="modal"
                            data-id="{{ $tweet->id }}"
                            data-title="{{ $tweet->title }}"
            ...
            <form id="editTweetForm" method="POST">
				...
				<div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        {{-- <input type="text" class="form-control" name="title" id="editTitle" value="{{ old('title') }}"> --}}
                        <small class="text-muted">Optional title</small>
                    </div>
					<div class="form-group">
						<label>Content</label>
