		...
		<div class="table-wrapper">
			<div class="table-title">
				<div class="row">
					...
					<div class="col-sm-6">
						<a href="#addEmployeeModal" class="btn btn-success" data-toggle="modal" id="addUserBtn"><i class="material-icons">&#xE147;</i> <span>Add New User</span></a>
			...
			<table class="table table-striped table-hover">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<a href="#editEmployeeModal" class="edit" data-toggle="modal" data-id="{{ $user->id }}"
